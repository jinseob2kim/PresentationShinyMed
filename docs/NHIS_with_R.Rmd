...
* [tidyverse](https://www.tidyverse.org/), [data.table](https://github.com/Rdatatable/data.table) 을 활용, 기존 [R](https://www.r-project.org/) 문법보다 빠르게 데이터 를 정리할 수 있다.  
]
...
out <- t20[substr(SICK_SYM1, 1, 3) %in% tg2.sickreg][order(MDCARE_STRT_DT)][, YEAR := substr(MDCARE_STRT_DT, 1, 4)][, .SD[1], by = INDI_DSCM_NO] 
```
...
- [jsmodule](https://github.com/jinseob2kim/jsmodule): 웹 기반 통계분석
